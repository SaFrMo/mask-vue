export default [
  { h: 'Welcome!', m: 'Welcome to The White Mask proof-of-concept! Press "next" to continue.' },
  { h: 'Goal', m: 'In The White Mask, you\'re playing as a freelancer helping hack-proof "smart paint" murals.' },
  ...
  { h: 'Method', t: '.money-bar', m: 'You have a limited amount of energy per infiltration. If the energy reaches 0, the security grid will find and eject you.' },
  ...
  { h: 'Turns', t: '.slice.placed', m: 'Your goal is to get your Slices to the far right of the board. Click on one of your Slices now.' },
  { h: 'Turns', t: '.slice.placed', m: 'Now, click on one of the highlighted cells to move to that cell.' },
  { h: 'Turns', t: '.slice.placed', m: 'You can only move a Slice once per turn. Press the "Finish Turn" button (or the spacebar) to end your turn.' },
